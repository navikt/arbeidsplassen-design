    ...
    render: (args) => (
        <RichText {...args}>
            ...
            <p>
                ...
                <b>søknad</b> og <strong>informasjonen</strong> du har oppgitt.
            </p>

            <p>
                Du søker kun med relevant informasjon for stillingen og kan når som helst
                <a href="#">trekke tilbake din søknad</a>
            </p>
