    ...
    <div>
      <GuidePanel poster illustration={<Icon />} className="mb-4">
        <div className="arb-guide-panel-lofsty">
          ...
          <BodyLong spacing>
            Du svarer kun på de kvalifikasjoner som bedriften legger vekt på i
            stillingen.
          </BodyLong>
          ...
          <BodyLong spacing>
            Du har mulighet til å skrive en begrunnelse om hvorfor akkurat du
          ...
          <BodyLong spacing>
            Uansett om bedriften ønsker å ta kontakt med deg eller ikke, gir vi
            deg en tilbakemelding på e-post sånn at du ikke går og lurer.
          </BodyLong>
          ...
          <BodyLong>
            ...
            helst trekke tilbake din søknad og informasjonen du har oppgitt.
          </BodyLong>
        </div>
      </GuidePanel>
