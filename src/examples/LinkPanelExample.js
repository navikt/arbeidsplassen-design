...
const LinkPanelExample = () => {
  return (
    <>
      <LinkPanel href="#" border={false} className="bg-tertiary-5 mb-2 pa-2">
      ...
      <LinkPanel href="#" border={false} className="bg-primary-20 mb-2 pa-2">
      ...
      <LinkPanel href="#" border={false} className="bg-secondary-20 mb-2 pa-2">
