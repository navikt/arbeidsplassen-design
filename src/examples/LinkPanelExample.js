...
const LinkPanelExample = () => {
    return (
        <>
            <LinkPanel href="#" border={false} className="bg-tertiary mb-2">
            ...
            <LinkPanel href="#" border={false} className="bg-primary mb-2">
            ...
            <LinkPanel href="#" border={false} className="bg-secondary mb-2">
