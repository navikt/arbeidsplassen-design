...
import { BodyLong, Box, Button, Heading, Label, Link, List, Stack } from "@navikt/ds-react";
        ...
        >
            <div className="container-large">
                ...
                <List aria-label="Beskrivelse av valgene du har:" className="mb-8">
                    <ListItem>
                        <Label as="span">Godta alle:</Label> Hjelper oss gjøre tjenestene bedre for deg basert på
                        anonymisert bruk.
                    </ListItem>
                    <ListItem>
                        <Label as="span">Bare nødvendige:</Label> Sikrer at tjenesten fungerer og er trygg. Kan ikke
                        velges bort.
                    </ListItem>
                </List>
